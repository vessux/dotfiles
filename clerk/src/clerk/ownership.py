...
This slice moves Clerk's command-boundary diagnostics to Python while leaving
workflow verb bodies on the legacy shell fallback. Ownership is therefore split:
Python owns global help/explain/version, manifest gating, and doctor; the active
workflow mutations remain unowned here and are exec'd into the fallback after the
